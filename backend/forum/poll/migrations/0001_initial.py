        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', django_extensions.db.fields.AutoSlugField(
                    blank=True, editable=False, verbose_name='Slug', unique=True, populate_from=('text',))),
                ('created_at', models.DateTimeField(
                    auto_now_add=True, verbose_name='Created at')),
                ('is_enabled', models.BooleanField(
                    verbose_name='Enabled', default=False)),
                ('created_by', models.ForeignKey(
                    to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('topic', models.ForeignKey(null=True, to='forum_base.Topic',
                                            verbose_name='In topic', default=None)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choice', models.ForeignKey(
                    to='forum_poll.Choice', verbose_name='Choice')),
                ('question', models.ForeignKey(
                    to='forum_poll.Question', verbose_name='Question')),
