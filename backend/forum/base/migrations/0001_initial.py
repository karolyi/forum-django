    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('friended_users', models.ManyToManyField(blank=True, help_text='The users who will see the part of the profile which is only visible for friended users.', related_name='_user_friended_users_+', to=settings.AUTH_USER_MODEL, verbose_name='Friended users')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('ignored_users', models.ManyToManyField(blank=True, help_text="An ignored user's posts are invisible when added here.", related_name='_user_ignored_users_+', to=settings.AUTH_USER_MODEL, verbose_name='List of ignored users')),
