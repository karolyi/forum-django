    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_comment', models.ForeignKey(related_name='last_comment', to='base.Comment', verbose_name='Last comment reference')),
                ('reply_to', models.ForeignKey(default=None, null=True, to='base.Topic', verbose_name='Reply to topic goes to')),
            ],
        ),
        migrations.AddField(
            model_name='comment',
            name='edits',
            field=models.ForeignKey(to='base.Edit', verbose_name='Edits'),
        ),
        migrations.AddField(
            model_name='comment',
            name='moved_from',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='moved_from', to='base.Topic', verbose_name='Comment moved from topic'),
        ),
        migrations.AddField(
            model_name='comment',
            name='prev_comment',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='base.Comment', verbose_name='Answered comment'),
        ),
        migrations.AddField(
            model_name='comment',
            name='topic',
            field=models.ForeignKey(to='base.Topic', verbose_name='Commented in topic'),
        ),
        migrations.AddField(
            model_name='comment',
            name='user',
